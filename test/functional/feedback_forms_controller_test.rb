...
class FeedbackFormsControllerTest < ActionController::TestCase
  ...
  test "should create feedback_form" do
    assert_difference('FeedbackForm.count') do
      post :create, feedback_form: { body: @feedback_form.body, email: @feedback_form.email, name: @feedback_form.name, phone: @feedback_form.phone }
    end
  ...
  test "should update feedback_form" do
    put :update, id: @feedback_form, feedback_form: { body: @feedback_form.body, email: @feedback_form.email, name: @feedback_form.name, phone: @feedback_form.phone }
    assert_redirected_to feedback_form_path(assigns(:feedback_form))
  end
